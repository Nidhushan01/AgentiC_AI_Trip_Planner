...
# Streamlit App Title
st.title("🌍 Agentic AI Trip Navigator")
...
# User Inputs
from_city = st.text_input("🏡 From City", "Colombo")
destination_city = st.text_input("✈️ Destination City", "New Delhi")
date_from = st.date_input("📅 Departure Date")
date_to = st.date_input("📅 Return Date")
interests = st.text_area("🎯 Your Interests (e.g., historical places, food, adventure)", "adventures and good food")

# Button to run CrewAI
if st.button("🚀 Generate a Travel Plan"):
